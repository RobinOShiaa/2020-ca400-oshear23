...
public class MainActivity extends AppCompatActivity {
    public static final String EXTRA_TEXT = "com.example.mylio.EXTRA_TEXT";
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if(resultCode == RESULT_OK){
                ...
                if (!recognizer.isOperational()){
                    ...
                    //get text from sb untile there is no text
    ...
    public void openActivity2(){
        EditText editText1 = (EditText) findViewById(R.id.resultEt);
    ...
    private boolean checkCameraPermission(){
        ...
        boolean other_result = ContextCompat.checkSelfPermission(this,Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
